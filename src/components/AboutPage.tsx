                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/20 dark:to-blue-900/20 rounded-3xl p-8 md:p-12">
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            {/* Center Column - Image and Green Stat Card */}
                            <div className="lg:col-span-1 flex flex-col gap-6">
                                {/* Communication Image */}
                                <div className="rounded-3xl overflow-hidden shadow-xl h-64 md:h-80">
                                    <ImageWithFallback
                                        src="https://images.unsplash.com/photo-1653379673150-4fb5c7f9c758?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYSUyMHNpZ24lMjBsYW5ndWFnZSUyMGNvbW11bmljYXtiZWxvd2VudHxfd2lkdGh8MHwxfHx8fDE3NjI0MDY2MjF8MA&ixlib=rb-4.1.0&q=80&w=1080"
